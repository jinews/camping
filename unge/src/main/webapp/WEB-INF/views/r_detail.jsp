...
<div class="wholebox">
	...
	<ul class="photo">
		<li><img src="/resources/upFile/${detail.rv_photo1 }" class="photo1"></li>
		<li><img src="/resources/upFile/${detail.rv_photo2 }" class="photo1"><br><br></li>
		<li><img src="/resources/upFile/${detail.rv_photo3 }" class="photo1"></li>
	</ul>
	<br>
